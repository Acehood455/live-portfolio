...
export const certificates = [
  {
    ...
    img: "/images/certificates/1_rwd.PNG",
    url: "https://www.freecodecamp.org/certification/acetaiwo/responsive-web-design",
  },
  {
    id: 2,
    title: "JavaScript Algorithms And Data Structures",
    img: "/images/certificates/2_jads.PNG",
    url: "https://www.freecodecamp.org/certification/acetaiwo/javascript-algorithms-and-data-structures-v8",
  },
  {
    id: 3,
    title: "Front End Development",
    img: "/images/certificates/3_fedl.PNG",
    url: "https://www.freecodecamp.org/certification/acetaiwo/front-end-development-libraries",
  },
  {
    id: 4,
    title: "Data Visualization",
    img: "/images/certificates/4_dv.PNG",
    url: "https://www.freecodecamp.org/certification/acetaiwo/data-visualization",
  },
  {
    id: 5,
    title: "Relational Database",
    img: "/images/certificates/5_rd.PNG",
    url: "https://www.freecodecamp.org/certification/acetaiwo/relational-database-v8",
  },
  {
    id: 6,
...
export const skills = [
  ...
  },
  {
    ...
    description:
      "A modern database toolkit — it makes working with databases as easy as writing JavaScript code.",
    color: "bg-teal-500",
  },
  {
    id: 12,
    ...
    description:
      "JavaScript with superpowers — it catches errors early and makes my code more reliable and easier to maintain.",
    color: "bg-blue-600",
  },
  {
    id: 13,
    name: "Framer Motion",
    img: "/images/skills/framer.png",
    description:
      "A powerful animation library for React — it makes websites feel smooth, alive, and full of motion.",
    color: "bg-pink-400",
  },
  {
    id: 14,
    ...
    description:
      "A hosting platform built for modern apps — it makes deploying websites fast, simple, and seamless.",
    color: "bg-zinc-500",
  },
  {
    id: 15,
    name: "Railway",
    img: "/images/skills/railway.png",
    description:
